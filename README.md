...
Adhan Swift supports Swift 4.0, Swift 4.2, Swift 5.0 and Objective-C.

Adhan Swift is a well tested and well documented library for calculating Islamic prayer times. Implementations of Adhan in other languages can be found in the parent repo [Adhan](https://github.com/batoulapps/Adhan).
